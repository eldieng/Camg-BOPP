...
export const adminService = {
  ...
  getRoleLabel: (r: UserRole) => ({ ACCUEIL: 'Accueil', TEST_VUE: 'Test Vue', MEDECIN: 'Médecin', ADMIN: 'Admin' }[r]),
  getRoleColor: (r: UserRole) => ({ ACCUEIL: 'bg-blue-100 text-blue-800', TEST_VUE: 'bg-purple-100 text-purple-800', MEDECIN: 'bg-green-100 text-green-800', ADMIN: 'bg-red-100 text-red-800' }[r]),
};
